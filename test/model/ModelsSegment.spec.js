...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsSegment', function() {
      beforeEach(function() {
        instance = new SendXAppServerV2.ModelsSegment();
      });

      it('should create an instance of ModelsSegment', function() {
        // TODO: update the code to test ModelsSegment
        expect(instance).to.be.a(SendXAppServerV2.ModelsSegment);
      });
