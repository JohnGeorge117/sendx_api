...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsDeepTeamAutomation', function() {
      beforeEach(function() {
        instance = new SendXAppServerV2.ModelsDeepTeamAutomation();
      });

      it('should create an instance of ModelsDeepTeamAutomation', function() {
        // TODO: update the code to test ModelsDeepTeamAutomation
        expect(instance).to.be.a(SendXAppServerV2.ModelsDeepTeamAutomation);
      });
