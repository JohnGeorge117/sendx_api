...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsDeepEmailSegment', function() {
      beforeEach(function() {
        instance = new SendXAppServerV2.ModelsDeepEmailSegment();
      });

      it('should create an instance of ModelsDeepEmailSegment', function() {
        // TODO: update the code to test ModelsDeepEmailSegment
        expect(instance).to.be.a(SendXAppServerV2.ModelsDeepEmailSegment);
      });
